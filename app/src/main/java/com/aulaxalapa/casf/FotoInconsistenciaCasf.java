...
public class FotoInconsistenciaCasf extends AppCompatActivity {
    ...
    Button btnGuardar;
    ImageView btnFoto;
    String imeistring, _ID, foto, imagen, fecha, folio, dm, PATH, guardado, nombre, folioCont;
    File file;
    TextView tvDatos;
    Boolean bool;
        ...
        btnGuardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(file.exists()){
                    ...
                    Toast.makeText(getApplicationContext(), "CAPTURAR IMÁGEN", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(bools){
            ...
            Intent inteF = new Intent(getApplicationContext(), FotoInconsistenciaCasf.class);
            startActivity(inteF);
            finish();
            foto="";
        }else{
            btnFoto.setImageResource(R.drawable.camara);
        }
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event)
    {
        ...
        {
            Intent int1 = new Intent(getApplicationContext(), FotoInconsistenciaCasf.class);
            startActivity(int1);
            return true;
        }else if (keyCode == 139){
